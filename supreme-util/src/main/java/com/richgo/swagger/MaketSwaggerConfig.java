 ...
 */
public class MaketSwaggerConfig {
    /**
     *
     * 配置参数
     *
    ...
    public Docket buildDocket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(buildApiInf()).globalOperationParameters(aParameters)
                .select().apis(RequestHandlerSelectors.basePackage("com.maket.controller"))// controller路径
    ...
    private ApiInfo buildApiInf() {
        return new ApiInfoBuilder().title("营销API").termsOfServiceUrl("").description("营销接口")
                .contact(new Contact("营销", "", "zhouxingyu@chtwm.com")).build();
