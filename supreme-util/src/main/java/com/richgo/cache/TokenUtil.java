package com.richgo.cache;

import com.richgo.assertions.Assertions;
import com.richgo.cache.CacheConts.PrefixTokenEnum;
import com.richgo.cache.EhCacheUtil.CacheTypeEnum;
import com.richgo.cache.bean.CacheAucdBean;
...
public class TokenUtil {
	 ...
	 * @return String
	 */
	public static String getkey(String bsKey, PrefixTokenEnum tokenEnum) {
	...
	public static boolean removeToken(String key) {
		return EhCacheUtil.remove(CacheTypeEnum.tokenCache, key);
	}
	...
	private static Object getValue(String key) {
		...
		Assertions.notEmpty("key", key);
		// 获取
		return EhCacheUtil.get(CacheTypeEnum.tokenCache, key);
	}
	...
	private static void putValue(String key, Object value) {
		...
		EhCacheUtil.put(CacheTypeEnum.tokenCache, key, value);
	}
}
